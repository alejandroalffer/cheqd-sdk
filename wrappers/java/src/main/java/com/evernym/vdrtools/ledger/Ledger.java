...
public class Ledger extends IndyJava.API {
	...
	private static Callback parseResponseCb = new Callback() {
		...
		public void callback(int xcommand_handle, int err, String id, String object_json) {
			...
			CompletableFuture<LedgerResults.ParseResponseResult> future = (CompletableFuture<LedgerResults.ParseResponseResult>) removeFuture(xcommand_handle);
			if (! checkResult(future, err)) return;

			LedgerResults.ParseResponseResult result = new LedgerResults.ParseResponseResult(id, object_json);
			future.complete(result);
		}
	};
	...
	private static Callback parseRegistryResponseCb = new Callback() {
		...
		public void callback(int xcommand_handle, int err, String id, String object_json, long timestamp) {
			...
			CompletableFuture<LedgerResults.ParseRegistryResponseResult> future = (CompletableFuture<LedgerResults.ParseRegistryResponseResult>) removeFuture(xcommand_handle);
			if (! checkResult(future, err)) return;

			LedgerResults.ParseRegistryResponseResult result = new LedgerResults.ParseRegistryResponseResult(id, object_json, timestamp);
			future.complete(result);
		}
	};
	 ...
	 * @throws IndyException Thrown if an error occurs when calling the underlying SDK.
	 */
	public static CompletableFuture<LedgerResults.ParseResponseResult> parseGetSchemaResponse(
			String getSchemaResponse) throws IndyException {

		ParamGuard.notNullOrWhiteSpace(getSchemaResponse, "data");

		CompletableFuture<LedgerResults.ParseResponseResult> future = new CompletableFuture<LedgerResults.ParseResponseResult>();
		int commandHandle = addFuture(future);
	 ...
	 * @throws IndyException Thrown if an error occurs when calling the underlying SDK.
	 */
	public static CompletableFuture<LedgerResults.ParseResponseResult> parseGetCredDefResponse(
	 ...
	 * @throws IndyException Thrown if an error occurs when calling the underlying SDK.
	 */
	public static CompletableFuture<LedgerResults.ParseResponseResult> parseGetRevocRegDefResponse(
	 ...
	 * @throws IndyException Thrown if an error occurs when calling the underlying SDK.
	 */
	public static CompletableFuture<LedgerResults.ParseRegistryResponseResult> parseGetRevocRegResponse(
			String getRevocRegResponse) throws IndyException {

		ParamGuard.notNullOrWhiteSpace(getRevocRegResponse, "data");

		CompletableFuture<LedgerResults.ParseRegistryResponseResult> future = new CompletableFuture<LedgerResults.ParseRegistryResponseResult>();
		int commandHandle = addFuture(future);
	 ...
	 * @throws IndyException Thrown if an error occurs when calling the underlying SDK.
	 */
	public static CompletableFuture<LedgerResults.ParseRegistryResponseResult> parseGetRevocRegDeltaResponse(
