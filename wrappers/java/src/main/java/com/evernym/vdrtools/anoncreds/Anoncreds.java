...
public class Anoncreds extends IndyJava.API {
	...
	private static Callback issuerCreateSchemaCb = new Callback() {
		...
		public void callback(int xcommand_handle, int err, String schema_id, String schema_json) {
			...
			CompletableFuture<AnoncredsResults.IssuerCreateSchemaResult> future = (CompletableFuture<AnoncredsResults.IssuerCreateSchemaResult>) removeFuture(xcommand_handle);
			if (! checkResult(future, err)) return;

			AnoncredsResults.IssuerCreateSchemaResult result = new AnoncredsResults.IssuerCreateSchemaResult(schema_id, schema_json);
	...
	private static Callback issuerCreateAndStoreCredentialDefCb = new Callback() {
		...
		public void callback(int xcommand_handle, int err, String credential_def_id, String credential_def_json) {
			...
			CompletableFuture<AnoncredsResults.IssuerCreateAndStoreCredentialDefResult> future = (CompletableFuture<AnoncredsResults.IssuerCreateAndStoreCredentialDefResult>) removeFuture(xcommand_handle);
			if (! checkResult(future, err)) return;

			AnoncredsResults.IssuerCreateAndStoreCredentialDefResult result = new AnoncredsResults.IssuerCreateAndStoreCredentialDefResult(credential_def_id, credential_def_json);
			future.complete(result);
		}
	};
	...
	private static Callback issuerCreateAndStoreRevocRegCb = new Callback() {
		...
		public void callback(int xcommand_handle, int err, String revoc_reg_id, String revoc_reg_def_json, String revoc_reg_entry_json) {
			...
			CompletableFuture<AnoncredsResults.IssuerCreateAndStoreRevocRegResult> future = (CompletableFuture<AnoncredsResults.IssuerCreateAndStoreRevocRegResult>) removeFuture(xcommand_handle);
			if (! checkResult(future, err)) return;

			AnoncredsResults.IssuerCreateAndStoreRevocRegResult result = new AnoncredsResults.IssuerCreateAndStoreRevocRegResult(revoc_reg_id, revoc_reg_def_json, revoc_reg_entry_json);
			future.complete(result);
		}
	};
	...
	private static Callback issuerCreateCredentialCb = new Callback() {
		...
		public void callback(int xcommand_handle, int err, String cred_json, String cred_rev_id, String revoc_reg_delta_json) {
			...
			CompletableFuture<AnoncredsResults.IssuerCreateCredentialResult> future = (CompletableFuture<AnoncredsResults.IssuerCreateCredentialResult>) removeFuture(xcommand_handle);
			if (! checkResult(future, err)) return;

			AnoncredsResults.IssuerCreateCredentialResult result = new AnoncredsResults.IssuerCreateCredentialResult(cred_json, cred_rev_id, revoc_reg_delta_json);
			future.complete(result);
		}
	};
	...
	private static Callback proverCreateCredentialReqCb = new Callback() {
		...
		public void callback(int xcommand_handle, int err, String credential_req_json, String credential_req_metadata_json) {
			...
			CompletableFuture<AnoncredsResults.ProverCreateCredentialRequestResult> future = (CompletableFuture<AnoncredsResults.ProverCreateCredentialRequestResult>) removeFuture(xcommand_handle);
			if (! checkResult(future, err)) return;

			AnoncredsResults.ProverCreateCredentialRequestResult result = new AnoncredsResults.ProverCreateCredentialRequestResult(credential_req_json, credential_req_metadata_json);
			future.complete(result);
		}
	};
	 ...
	 */
	public static CompletableFuture<AnoncredsResults.IssuerCreateSchemaResult> issuerCreateSchema(
			String issuerDid,
			String name,
			String version,
		...
		CompletableFuture<AnoncredsResults.IssuerCreateSchemaResult> future = new CompletableFuture<AnoncredsResults.IssuerCreateSchemaResult>();
	 ...
	 * @throws IndyException Thrown if an error occurs when calling the underlying SDK.
	 */
	public static CompletableFuture<AnoncredsResults.IssuerCreateAndStoreCredentialDefResult> issuerCreateAndStoreCredentialDef(
			Wallet wallet,
			String issuerDid,
			String schemaJson,
			String tag,
		...
		CompletableFuture<AnoncredsResults.IssuerCreateAndStoreCredentialDefResult> future = new CompletableFuture<AnoncredsResults.IssuerCreateAndStoreCredentialDefResult>();
		int commandHandle = addFuture(future);
	 ...
	 * @throws IndyException Thrown if an error occurs when calling the underlying SDK.
	 */
	public static CompletableFuture<AnoncredsResults.IssuerCreateAndStoreRevocRegResult> issuerCreateAndStoreRevocReg(
			Wallet wallet,
			String issuerDid,
		...
		CompletableFuture<AnoncredsResults.IssuerCreateAndStoreRevocRegResult> future = new CompletableFuture<AnoncredsResults.IssuerCreateAndStoreRevocRegResult>();
		int commandHandle = addFuture(future);
	 ...
	 * @throws IndyException Thrown if an error occurs when calling the underlying SDK.
	 */
	public static CompletableFuture<AnoncredsResults.IssuerCreateCredentialResult> issuerCreateCredential(
			Wallet wallet,
		...
		CompletableFuture<AnoncredsResults.IssuerCreateCredentialResult> future = new CompletableFuture<AnoncredsResults.IssuerCreateCredentialResult>();
		int commandHandle = addFuture(future);
...
//	}
	 ...
	 * @throws IndyException Thrown if an error occurs when calling the underlying SDK.
	 */
	public static CompletableFuture<AnoncredsResults.ProverCreateCredentialRequestResult> proverCreateCredentialReq(
			Wallet wallet,
			String proverDid,
		...
		CompletableFuture<AnoncredsResults.ProverCreateCredentialRequestResult> future = new CompletableFuture<AnoncredsResults.ProverCreateCredentialRequestResult>();
		int commandHandle = addFuture(future);
