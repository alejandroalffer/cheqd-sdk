...
public class Payments extends IndyJava.API {
    ...
    private static Callback parsePaymentResponseWithFromCompleteCb = new Callback() {
        ...
        public void callback(int xcommandHandle, int err, String paymentAddress, int num) {
            CompletableFuture<PaymentsResults.ParseGetPaymentSourcesWithFromResponseResult> future = (CompletableFuture<PaymentsResults.ParseGetPaymentSourcesWithFromResponseResult>) removeFuture(xcommandHandle);
            if (!checkResult(future, err)) return;

            PaymentsResults.ParseGetPaymentSourcesWithFromResponseResult parsePaymentResponseWithFromResponseResult =
                    new PaymentsResults.ParseGetPaymentSourcesWithFromResponseResult(paymentAddress, num);
    ...
    private static Callback addRequestFeesCb = new Callback() {
        ...
        public void callback(int xcommandHandle, int err, String reqWithFeesJson, String paymentMethod) {
            CompletableFuture<PaymentsResults.AddRequestFeesResult> future = (CompletableFuture<PaymentsResults.AddRequestFeesResult>) removeFuture(xcommandHandle);
            if (!checkResult(future, err)) return;

            PaymentsResults.AddRequestFeesResult addRequestFeesResult = new PaymentsResults.AddRequestFeesResult(reqWithFeesJson, paymentMethod);
    ...
    private static Callback BuildGetPaymentSourcesRequestCB = new Callback() {
        ...
        public void callback(int xcommandHandle, int err, String sourcesJson, String paymentMethod) {
            CompletableFuture<PaymentsResults.BuildGetPaymentSourcesRequestResult> future = (CompletableFuture<PaymentsResults.BuildGetPaymentSourcesRequestResult>) removeFuture(xcommandHandle);
            if (!checkResult(future, err)) return;

            PaymentsResults.BuildGetPaymentSourcesRequestResult addRequestFeesResult = new PaymentsResults.BuildGetPaymentSourcesRequestResult(sourcesJson, paymentMethod);
    ...
    private static Callback buildPaymentReqCb = new Callback() {
        ...
        public void callback(int xcommandHandle, int err, String paymentReqJson, String paymentMethod) {
            CompletableFuture<PaymentsResults.BuildPaymentReqResult> future = (CompletableFuture<PaymentsResults.BuildPaymentReqResult>) removeFuture(xcommandHandle);
            if (!checkResult(future, err)) return;

            PaymentsResults.BuildPaymentReqResult addRequestFeesResult = new PaymentsResults.BuildPaymentReqResult(paymentReqJson, paymentMethod);
    ...
    private static Callback buildMintReqCb = new Callback() {
        ...
        public void callback(int xcommandHandle, int err, String mintReqJson, String paymentMethod) {
            CompletableFuture<PaymentsResults.BuildMintReqResult> future = (CompletableFuture<PaymentsResults.BuildMintReqResult>) removeFuture(xcommandHandle);
            if (!checkResult(future, err)) return;

            PaymentsResults.BuildMintReqResult addRequestFeesResult = new PaymentsResults.BuildMintReqResult(mintReqJson, paymentMethod);
	...
	private static Callback buildVerifyPaymentReqCb = new Callback() {
		...
		public void callback(int xcommandHandle, int err, String verifyReqJson, String paymentMethod) {
			CompletableFuture<PaymentsResults.BuildVerifyPaymentReqResult> future = (CompletableFuture<PaymentsResults.BuildVerifyPaymentReqResult>) removeFuture(xcommandHandle);
			if (!checkResult(future, err)) return;

			PaymentsResults.BuildVerifyPaymentReqResult verifyRequestResult = new PaymentsResults.BuildVerifyPaymentReqResult(verifyReqJson, paymentMethod);
     ...
     * @throws IndyException Thrown if a call to the underlying SDK fails.
     */
    public static CompletableFuture<PaymentsResults.AddRequestFeesResult> addRequestFees(
            Wallet wallet,
            String submitterDid,
            String reqJson,
            String inputsJson,
        ...
        CompletableFuture<PaymentsResults.AddRequestFeesResult> future = new CompletableFuture<>();
        int commandHandle = addFuture(future);
     ...
     */
    @Deprecated
    public static CompletableFuture<PaymentsResults.BuildGetPaymentSourcesRequestResult> buildGetPaymentSourcesRequest(
            Wallet wallet,
            String submitterDid,
        ...
        CompletableFuture<PaymentsResults.BuildGetPaymentSourcesRequestResult> future = new CompletableFuture<>();
        int commandHandle = addFuture(future);
     ...
     * @throws IndyException Thrown if a call to the underlying SDK fails.
     */
    public static CompletableFuture<PaymentsResults.BuildGetPaymentSourcesRequestResult> buildGetPaymentSourcesWithFromRequest(
            Wallet wallet,
            String submitterDid,
            String paymentAddress,
            int from
     ...
     * @throws IndyException Thrown if a call to the underlying SDK fails.
     */
    public static CompletableFuture<PaymentsResults.BuildPaymentReqResult> buildPaymentRequest(
            Wallet wallet,
            String submitterDid,
            String inputsJson,
            String outputsJson,
        ...
        CompletableFuture<PaymentsResults.BuildPaymentReqResult> future = new CompletableFuture<>();
        int commandHandle = addFuture(future);
     ...
     * @throws IndyException Thrown if a call to the underlying SDK fails.
     */
    public static CompletableFuture<PaymentsResults.BuildMintReqResult> buildMintRequest(
            Wallet wallet,
            String submitterDid,
            String outputsJson,
            String extra
        ...
        CompletableFuture<PaymentsResults.BuildMintReqResult> future = new CompletableFuture<>();
        int commandHandle = addFuture(future);
     ...
     * @throws IndyException Thrown if a call to the underlying SDK fails.
     */
    public static CompletableFuture<PaymentsResults.BuildVerifyPaymentReqResult> buildVerifyPaymentRequest(
            Wallet wallet,
            String submitterDid,
            String receipt
    ) throws IndyException {
        ...
        CompletableFuture<PaymentsResults.BuildVerifyPaymentReqResult> future = new CompletableFuture<>();
        int commandHandle = addFuture(future);
