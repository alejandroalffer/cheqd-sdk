...
import static com.evernym.vdrtools.utils.EnvironmentUtils.getIndyHomePath;
...
public class AnoncredsDemoTest extends IndyIntegrationTest {
	...
	public void testAnoncredsDemo() throws Exception {
		...
		AnoncredsResults.IssuerCreateAndStoreCredentialDefResult createCredDefResult = Anoncreds.issuerCreateAndStoreCredentialDef(issuerWallet, issuerDid, gvtSchema, TAG, null, DEFAULT_CRED_DEF_CONFIG).get();
		...
		AnoncredsResults.ProverCreateCredentialRequestResult createCredReqResult = Anoncreds.proverCreateCredentialReq(proverWallet, proverDid, credOffer, credDef, masterSecretId).get();
	...
	public void testAnoncredsWorksForMultipleIssuerSingleProver() throws Exception {
		...
		AnoncredsResults.IssuerCreateAndStoreCredentialDefResult createCredDefResult = Anoncreds.issuerCreateAndStoreCredentialDef(issuerGvtWallet, issuerDid, gvtSchema, TAG, null, DEFAULT_CRED_DEF_CONFIG).get();
		...
		AnoncredsResults.ProverCreateCredentialRequestResult createCredReqResult = Anoncreds.proverCreateCredentialReq(proverWallet, proverDid, gvtCredOffer, gvtCredDef, masterSecretId).get();
		...
		// Issuer create Credential
		AnoncredsResults.IssuerCreateCredentialResult gvtCreateCredentialResult =
		...
		// Issuer create Credential
		AnoncredsResults.IssuerCreateCredentialResult xyzCreateCredentialResult = Anoncreds.issuerCreateCredential(issuerXyzWallet, xyzCredOffer, xyzCredReq, xyzCredentialValues, null, - 1).get();
	...
	public void testAnoncredsWorksForSingleIssuerSingleProverMultipleCredentials() throws Exception {
		...
		AnoncredsResults.IssuerCreateCredentialResult xyzCreateCredentialResult =
	...
	public void testAnoncredsWorksForRevocationProof() throws Exception {
		...
		String tailsWriterConfig = new JSONObject(String.format("{\"base_dir\":\"%s\", \"uri_pattern\":\"\"}", EnvironmentUtils.getIndyHomePath("tails")).replace('\\', '/')).toString();
