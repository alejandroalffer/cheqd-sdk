...
import static com.evernym.vdrtools.utils.EnvironmentUtils.getTmpPath;
...
public class IndyIntegrationTest {
	...
	protected String TAILS_WRITER_CONFIG =
			"{ \"base_dir\":\"" +  EnvironmentUtils.getIndyHomePath("tails").replace('\\', '/') + "\", \"uri_pattern\":\"\"}";
	...
	protected static final String EXPORT_PATH = EnvironmentUtils.getTmpPath("export_wallet");
