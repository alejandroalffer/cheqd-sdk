package com.evernym.vdrtools.interaction;
...
import com.evernym.vdrtools.blob_storage.*;
import com.evernym.vdrtools.did.Did;
import com.evernym.vdrtools.did.DidResults;
import com.evernym.vdrtools.ledger.Ledger;
import com.evernym.vdrtools.ledger.LedgerResults;
import com.evernym.vdrtools.ledger.LedgerResults.ParseResponseResult;
...
public class AnoncredsRevocationInteractionTest extends IndyIntegrationTestWithPoolAndSingleWallet {
	...
	public void testAnoncredsRevocationInteractionIssuanceByDemand() throws Exception {
		...
		String tailsWriterConfig = new JSONObject(String.format("{\"base_dir\":\"%s\", \"uri_pattern\":\"\"}",
				EnvironmentUtils.getIndyHomePath("tails")).replace('\\', '/')).toString();
