...
use crate::{BString, CString, CommandHandle, Error, StorageHandle};
...
extern "C" {
    ...
    pub fn indy_close_wallet(
        command_handle: CommandHandle,
        wallet_handle: WalletHandle,
        cb: Option<ResponseEmptyCB>,
    ) -> Error;

    pub fn indy_delete_wallet(
        command_handle: CommandHandle,
        config: CString,
        credentials: CString,
        cb: Option<ResponseEmptyCB>,
    ...
    pub fn indy_generate_wallet_key(
        command_handle: CommandHandle,
        config: CString,
...
pub type WalletOpen = extern "C" fn(
    ...
    config: CString,
    credentials_json: CString,
    storage_handle_p: *mut StorageHandle,
) -> Error;

pub type WalletClose = extern "C" fn(storage_handle: StorageHandle) -> Error;

pub type WalletDelete =
    extern "C" fn(name: CString, config: CString, credentials_json: CString) -> Error;
...
pub type WalletDeleteRecord =
    extern "C" fn(storage_handle: StorageHandle, type_: CString, id: CString) -> Error;
...
pub type WalletGetRecordTags = extern "C" fn(
    storage_handle: StorageHandle,
    record_handle: RecordHandle,
    record_tags_p: *mut CString,
) -> Error;

pub type WalletFreeRecord =
    extern "C" fn(storage_handle: StorageHandle, record_handle: RecordHandle) -> Error;

pub type WalletGetStorageMetadata = extern "C" fn(
    storage_handle: StorageHandle,
    metadata_p: *mut CString,
    metadata_handle: *mut MetadataHandle,
) -> Error;

pub type WalletSetStorageMetadata =
    extern "C" fn(storage_handle: StorageHandle, metadata_p: CString) -> Error;

pub type WalletFreeStorageMetadata =
    extern "C" fn(storage_handle: StorageHandle, metadata_handle: MetadataHandle) -> Error;
...
pub type WalletSearchRecords = extern "C" fn(
    ...
    query_json: CString,
    options_json: CString,
    search_handle_p: *mut SearchHandle,
) -> Error;

pub type WalletSearchAllRecords =
    extern "C" fn(storage_handle: StorageHandle, search_handle_p: *mut SearchHandle) -> Error;
...
pub type WalletFreeSearch =
    extern "C" fn(storage_handle: StorageHandle, search_handle: SearchHandle) -> Error;
