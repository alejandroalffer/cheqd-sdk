...
fn _build_msg_create_nym(
    ...
    ErrorCode::from(unsafe {
        cheqd_ledger::cheqd::indy_cheqd_ledger_cheqd_build_msg_create_nym(
            command_handle,
            did.as_ptr(),
            creator.as_ptr(),
            verkey.as_ptr(),
...
fn _parse_msg_create_nym_resp(
    ...
    ErrorCode::from(unsafe {
        cheqd_ledger::cheqd::indy_cheqd_ledger_cheqd_parse_msg_create_nym_resp(
            command_handle,
            commit_resp.as_ptr(),
            cb,
        )
...
fn _build_msg_update_nym(
    ...
    ErrorCode::from(unsafe {
        cheqd_ledger::cheqd::indy_cheqd_ledger_cheqd_build_msg_update_nym(
            command_handle,
            did.as_ptr(),
            creator.as_ptr(),
            verkey.as_ptr(),
...
fn _parse_msg_update_nym_resp(
    ...
    ErrorCode::from(unsafe {
        cheqd_ledger::cheqd::indy_cheqd_ledger_cheqd_parse_msg_update_nym_resp(
            command_handle,
            commit_resp.as_ptr(),
            cb,
        )
...
fn _build_msg_delete_nym(
    ...
    ErrorCode::from(unsafe {
        cheqd_ledger::cheqd::indy_cheqd_ledger_cheqd_build_msg_delete_nym(
            command_handle,
            creator.as_ptr(),
            id,
            cb,
...
fn _parse_msg_delete_nym_resp(
    ...
    ErrorCode::from(unsafe {
        cheqd_ledger::cheqd::indy_cheqd_ledger_cheqd_parse_msg_delete_nym_resp(
            command_handle,
            commit_resp.as_ptr(),
            cb,
        )
...
fn _build_query_get_nym(
    ...
    ErrorCode::from(unsafe {
        cheqd_ledger::cheqd::indy_cheqd_ledger_cheqd_build_query_get_nym(command_handle, id, cb)
    })
}
...
fn _parse_query_get_nym_resp(
    ...
    ErrorCode::from(unsafe {
        cheqd_ledger::cheqd::indy_cheqd_ledger_cheqd_parse_query_get_nym_resp(
            command_handle,
            query_resp.as_ptr(),
            cb,
        )
...
fn _build_query_all_nym(
    ...
    ErrorCode::from(unsafe {
        cheqd_ledger::cheqd::indy_cheqd_ledger_cheqd_build_query_all_nym(command_handle, cb)
    })
}
...
fn _parse_query_all_nym_resp(
    ...
    ErrorCode::from(unsafe {
        cheqd_ledger::cheqd::indy_cheqd_ledger_cheqd_parse_query_all_nym_resp(
            command_handle,
            query_resp.as_ptr(),
            cb,
        )
