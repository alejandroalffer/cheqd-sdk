...
lazy_static! {
    ...
    static ref CALLBACKS_PREPAREDTXNHANDLE: Mutex<HashMap<CommandHandle, oneshot::Sender<Result<(String, String, Vec<u8>, String), IndyError>>>> = Default::default();
...
impl ClosureHandler {
    ...
    cb_ec!(cb_ec_preparedtxnhandle(context: *const c_char, signature_spec: *const c_char, bytes_to_sign_raw: *const u8, bytes_to_sign_len: u32, endorsement_spec: *const c_char)->(String, String, Vec<u8>, String),
        CALLBACKS_PREPAREDTXNHANDLE,
        (rust_str!(context), rust_str!(signature_spec), rust_slice!(bytes_to_sign_raw, bytes_to_sign_len).to_owned(), rust_str!(endorsement_spec)));
...
impl ResultHandler {
    ...
    result_handler!(preparedtxnhandle((String, String, Vec<u8>, String)), CALLBACKS_PREPAREDTXNHANDLE);
