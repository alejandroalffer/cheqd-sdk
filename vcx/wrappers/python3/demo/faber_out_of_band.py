...
async def main():
    ...
    schema = await Schema.create('schema_uuid', 'degree schema', version, ['email'], 0)
    ...
    connection_to_alice = await Connection.create_outofband('alice', None, None, True, json.dumps(offer))
