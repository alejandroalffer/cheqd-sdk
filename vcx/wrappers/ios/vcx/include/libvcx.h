...
vcx_error_t vcx_provision_agent_with_token(vcx_command_handle_t handle, const char *json, const char *token, void (*cb)(vcx_command_handle_t command_handle, vcx_error_t err, const char *config));
