...
cfg_if::cfg_if! {
   if #[cfg(feature = "cheqd")] {
    CommandExecutor::build()
        ...
        .add_command(cheqd_ledger::get_account_command::new())
        .add_command(cheqd_ledger::create_nym_command::new())
        .add_command(cheqd_ledger::get_nym_command::new())
        .add_command(cheqd_ledger::get_all_nym_command::new())
        .add_command(cheqd_ledger::bank_send_command::new())
        .add_command(cheqd_ledger::get_balance_command::new())
        .finalize_group()
        ...
        .add_command(cheqd_pool::get_all_config_command::new())
        ...
        .add_command(cheqd_keys::get_list_keys_command::new())
        .finalize_group()
        .finalize()
   } else {
        CommandExecutor::build()
