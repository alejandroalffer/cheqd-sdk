...
use crate::libindy::ledger::Ledger2;
...
pub mod group {
    ...
    command_group!(CommandGroupMetadata::new("ledger2", "Verim Ledger management commands"));
}
...
macro_rules! send_request {
    ($ctx:expr, $params:expr, $request:expr, $wallet_name:expr, $submitter_did:expr, $send:expr) => ({
        if $send {
            ...
            let response_json = Ledger2::submit_request(pool_handle, $request)
