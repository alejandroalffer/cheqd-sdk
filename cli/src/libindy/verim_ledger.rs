...
impl VerimLedger {
    pub fn parse_query_account_resp(query_resp: &str) -> Result<String, IndyError> {
        verim::parse_query_account_resp(query_resp).wait()
    }

    pub fn build_query_account(address: &str) -> Result<String, IndyError> {
        verim::build_query_account(query_resp).wait()
    }
    ...
    pub fn build_tx(pool_alias: &str,
        ...
        verim::build_tx(pool_alias, sender_public_key, msg, account_number, sequence_number, max_gas, max_coin_amount, max_coin_denom, timeout_height, memo).wait()
    }
    ...
    pub fn build_msg_create_nym(did: &str,
        ...
        verim::build_msg_create_nym(did, creator, verkey, alias, role).wait()
    }

    pub fn parse_msg_create_nym_resp(commit_resp: &str) -> Result<String, IndyError> {
        verim::parse_msg_create_nym_resp(commit_resp).wait()
    }
