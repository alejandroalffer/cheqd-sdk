...
/// Common*
#[no_mangle]
pub extern "C" fn indy_add_random(
    alias: *const c_char,
    cb: Option<
        extern "C" fn(
    ...
    let cb = move |res: IndyResult<_>| {
        ...
        cb(command_handle, err, alias.as_ptr(), account_id.as_ptr(), pub_key.as_ptr())
    };
...
/// Common*
#[no_mangle]
pub extern "C" fn add_from_mnemonic(
    alias: *const c_char,
    ...
    let cb = move |res: IndyResult<_>| {
        ...
        debug!(
            "add_from_mnemonic ? err {:?} key_info {:?}",
            err, key_info
        );
