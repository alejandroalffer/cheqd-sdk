...
pub enum CommandMetric {
    ...
    CheqdLedgerCommandBuildMsgCreateNym,
    CheqdLedgerCommandBuildMsgUpdateNym,
    CheqdLedgerCommandBuildMsgDeleteNym,
    CheqdLedgerCommandBuildQueryGetNym,
    CheqdLedgerCommandBuildQueryAllNym,
    CheqdLedgerCommandParseMsgCreateNymResp,
    CheqdLedgerCommandParseMsgUpdateNymResp,
    CheqdLedgerCommandParseMsgDeleteNymResp,
    CheqdLedgerCommandParseQueryGetNymResp,
    CheqdLedgerCommandParseQueryAllNymResp,
