...
use super::super::super::proto::cheqdid::cheqdnode::cheqd::QueryGetNymResponse as ProtoQueryGetNymResponse;
...
impl CheqdProto for QueryGetNymResponse {
...
mod test {
    ...
    fn test_query_get_nym_response() {
        ...
        let decoded = QueryGetNymResponse::from_proto(&proto).unwrap();
