...
mod demos {
    ...
    use utils::{
        ...
        domain::anoncreds::{
            ...
            credential_offer::CredentialOffer, proof::Proof,
    ...
    fn anoncreds_works_for_single_issuer_single_prover() {
        ...
        let (issuer_wallet_handle, issuer_wallet_config) = wallet::create_and_open_default_wallet(
            "anoncreds_works_for_single_issuer_single_prover",
        )
        .unwrap();
        ...
        let revealed_attr_groups = proof
            .requested_proof
    ...
    fn anoncreds_works_for_plugged_wallet() {
        ...
        let issuer_wallet_handle =
            wallet::open_wallet(&issuer_wallet_config, WALLET_CREDENTIALS).unwrap();
        ...
        let prover_wallet_handle =
            wallet::open_wallet(&prover_wallet_config, WALLET_CREDENTIALS).unwrap();
    ...
    fn anoncreds_works_for_multiple_issuer_single_prover() {
        ...
        let (issuer_gvt_wallet_handle, issuer_gvt_wallet_config) =
            wallet::create_and_open_default_wallet(
                "anoncreds_works_for_multiple_issuer_single_prover",
            )
            .unwrap();
        ...
        let credential_for_predicate_1 = anoncreds::get_credential_for_predicate_referent(
            &credentials_json,
            "predicate1_referent",
        );
        let credential_for_predicate_2 = anoncreds::get_credential_for_predicate_referent(
            &credentials_json,
            "predicate2_referent",
        );
        ...
        wallet::close_and_delete_wallet(prover_wallet_handle, &prover_wallet_config).unwrap();
        wallet::close_and_delete_wallet(issuer_gvt_wallet_handle, &issuer_gvt_wallet_config)
            .unwrap();
        wallet::close_and_delete_wallet(issuer_xyz_wallet_handle, &issuer_xyz_wallet_config)
            .unwrap();
    }
    ...
    fn anoncreds_works_for_mysql_wallet() {
        ...
        //1. FIXME: register mysql storage
        ...
        wallet::create_wallet(&issuer_wallet_config, &issuer_wallet_credentials).unwrap();

        let issuer_wallet_handle =
            wallet::open_wallet(&issuer_wallet_config, &issuer_wallet_credentials).unwrap();
        ...
        let prover_wallet_credentials = json!({
            "key": "proverKey1111111111111111111111111111111111",
            "key_derivation_method": "RAW",
            "storage_credentials": storage_creds
        })
        .to_string();

        wallet::create_wallet(&prover_wallet_config, &prover_wallet_credentials).unwrap();

        let prover_wallet_handle =
            wallet::open_wallet(&prover_wallet_config, &prover_wallet_credentials).unwrap();
        ...
        wallet::delete_wallet(&prover_wallet_config, &prover_wallet_credentials).unwrap();

        wallet::close_wallet(issuer_wallet_handle).unwrap();
        wallet::delete_wallet(&issuer_wallet_config, &issuer_wallet_credentials).unwrap();
    }
    ...
    fn anoncreds_works_for_revocation_proof_issuance_by_demand() {
        ...
        let (issuer_wallet_handle, issuer_wallet_config) = wallet::create_and_open_default_wallet(
            "anoncreds_works_for_revocation_proof_issuance_by_demand",
        )
        .unwrap();
        ...
        let (cred_rev_id, revoc_reg_delta_json) =
        ...
        //7. Prover gets Credentials for Proof Request
        let credentials_json =
            anoncreds::prover_get_credentials_for_proof_req(prover_wallet_handle, &proof_request)
                .unwrap();
    ...
    fn anoncreds_works_for_revocation_proof_issuance_by_default() {
        ...
        //1. Issuer creates wallet, gets wallet handle
        let (issuer_wallet_handle, issuer_wallet_config) = wallet::create_and_open_default_wallet(
            "anoncreds_works_for_revocation_proof_issuance_by_default",
        )
        .unwrap();
    ...
    fn anoncreds_works_for_revocation_proof_for_issuance_and_proving_three_credential() {
        ...
        let (issuer_wallet_handle, issuer_wallet_config) = wallet::create_and_open_default_wallet(
            "anoncreds_works_for_revocation_proof_for_issuance_and_proving_three_credential",
        )
        .unwrap();

        // Prover1 creates wallet, gets wallet handle
        let (prover1_wallet_handle, prover1_wallet_config) =
            wallet::create_and_open_default_wallet(
                "anoncreds_works_for_revocation_proof_for_issuance_and_proving_three_credential",
            )
            .unwrap();
        ...
        let (prover2_wallet_handle, prover2_wallet_config) =
            wallet::create_and_open_default_wallet(
                "anoncreds_works_for_revocation_proof_for_issuance_and_proving_three_credential",
            )
            .unwrap();
        ...
        let (prover3_wallet_handle, prover3_wallet_config) =
            wallet::create_and_open_default_wallet(
                "anoncreds_works_for_revocation_proof_for_issuance_and_proving_three_credential",
            )
            .unwrap();
        ...
        let (prover2_cred_rev_id, revoc_reg_delta2_json) =
            anoncreds::multi_steps_create_revocation_credential(
        ...
        anoncreds::prover_create_master_secret(prover3_wallet_handle, prover3_master_secret_id)
            .unwrap();

        let (prover3_cred_rev_id, revoc_reg_delta3_json) =
            anoncreds::multi_steps_create_revocation_credential(
        ...
        let prover1_credential = anoncreds::get_credential_for_attr_referent(
            &prover1_credentials_json,
            "attr1_referent",
        );
        ...
        let prover1_rev_state_json = anoncreds::create_revocation_state(
            blob_storage_reader_handle,
            &revoc_reg_def_json,
            &revoc_reg_delta_json,
            timestamp,
        ...
        let prover2_credentials_json =
            anoncreds::prover_get_credentials_for_proof_req(prover2_wallet_handle, &proof_request)
                .unwrap();

        let prover2_credential = anoncreds::get_credential_for_attr_referent(
            &prover2_credentials_json,
            "attr1_referent",
        );
        ...
        let prover2_rev_state_json = anoncreds::create_revocation_state(
            blob_storage_reader_handle,
            &revoc_reg_def_json,
            &revoc_reg_delta_json,
            timestamp,
        ...
        let proof2_json = anoncreds::prover_create_proof(
            prover2_wallet_handle,
            &proof_request,
            &requested_credentials_json,
            prover2_master_secret_id,
        ...
        let prover3_credentials_json =
            anoncreds::prover_get_credentials_for_proof_req(prover3_wallet_handle, &proof_request)
                .unwrap();

        let prover3_credential = anoncreds::get_credential_for_attr_referent(
            &prover3_credentials_json,
            "attr1_referent",
        );
        ...
        let prover3_rev_state_json = anoncreds::create_revocation_state(
            blob_storage_reader_handle,
            &revoc_reg_def_json,
            &revoc_reg_delta_json,
            timestamp,
        ...
        let proof3_json = anoncreds::prover_create_proof(
            prover3_wallet_handle,
            &proof_request,
            &requested_credentials_json,
            prover3_master_secret_id,
    ...
    fn anoncreds_works_for_twice_entry_of_attribute_from_different_credential() {
        ...
        wallet::close_and_delete_wallet(issuer_abc_wallet_handle, &issuer_abc_wallet_config)
            .unwrap();
    }
    ...
    fn anoncreds_works_for_issuance_on_demand_revocation_strategy_revoke_credential() {
        ...
        let revoc_reg_delta_json = anoncreds::issuer_revoke_credential(
            issuer_wallet_handle,
            blob_storage_reader_handle,
            &rev_reg_id,
            &cred_rev_id,
    ...
    fn anoncreds_works_for_issuance_by_default_revocation_strategy_revoke_credential() {
        ...
        //1. Issuer creates wallet, gets wallet handle
        let (issuer_wallet_handle, issuer_wallet_config) = wallet::create_and_open_default_wallet(
            "anoncreds_works_for_issuance_by_default_revocation_strategy_revoke_credential_issuer",
        )
        .unwrap();

        //2. Prover creates wallet, gets wallet handle
        let (prover_wallet_handle, prover_wallet_config) = wallet::create_and_open_default_wallet(
            "anoncreds_works_for_issuance_by_default_revocation_strategy_revoke_credential_prover",
        )
        .unwrap();
    ...
    fn anoncreds_works_for_issuance_by_demand_revocation_strategy_for_full_revocation_registry() {
        ...
        anoncreds::prover_create_master_secret(prover_1_wallet_handle, prover_1_master_secret)
            .unwrap();
        ...
        anoncreds::prover_create_master_secret(prover_2_wallet_handle, prover_2_master_secret)
            .unwrap();

        anoncreds::multi_steps_create_revocation_credential(
            prover_2_master_secret,
        ...
        anoncreds::prover_create_master_secret(prover_3_wallet_handle, prover_3_master_secret)
            .unwrap();

        let cred_offer_json =
            anoncreds::issuer_create_credential_offer(issuer_wallet_handle, &cred_def_id).unwrap();

        let (cred_req_json, _) = anoncreds::prover_create_credential_req(
            prover_3_wallet_handle,
            DID_MY2,
            &cred_offer_json,
            &cred_def_json,
            prover_3_master_secret,
        )
        .unwrap();

        let res = anoncreds::issuer_create_credential(
            issuer_wallet_handle,
            &cred_offer_json,
            &cred_req_json,
            &anoncreds::gvt_credential_values_json(),
    ...
    fn anoncreds_works_for_issuance_by_demand_revocation_strategy_for_revoke_not_issued_credential_id(
        ...
        let (_, schema_json) = anoncreds::issuer_create_schema(
            ISSUER_DID,
            GVT_SCHEMA_NAME,
            SCHEMA_VERSION,
            GVT_SCHEMA_ATTRIBUTES,
        ...
        let (cred_def_id, _) = anoncreds::issuer_create_credential_definition(
            issuer_wallet_handle,
            ISSUER_DID,
            &schema_json,
            TAG_1,
        ...
        let tails_writer_handle =
            utils::blob_storage::open_writer("default", &tails_writer_config).unwrap();

        let (rev_reg_id, _, _) = anoncreds::issuer_create_and_store_revoc_reg(
            issuer_wallet_handle,
            &ISSUER_DID,
            None,
            TAG_1,
        ...
        let blob_storage_reader_handle =
            utils::blob_storage::open_reader(TYPE, &tails_writer_config).unwrap();

        //5. Issuer revokes Credential by not issued id
        let cred_rev_id = "100";

        let res = anoncreds::issuer_revoke_credential(
            issuer_wallet_handle,
            blob_storage_reader_handle,
            &rev_reg_id,
            cred_rev_id,
    ...
    fn anoncreds_works_for_issuance_by_default_revocation_strategy_for_revoke_not_issued_credential_id(
        ...
        let (_, _, _, _, rev_reg_id, _, _, blob_storage_reader_handle) =
            anoncreds::multi_steps_issuer_revocation_preparation(
                issuer_wallet_handle,
                ISSUER_DID,
                GVT_SCHEMA_NAME,
    ...
    fn anoncreds_works_for_multiple_requested_predicates_from_one_credential() {
        ...
        let credential = anoncreds::get_credential_for_predicate_referent(
            &credentials_json,
            "predicate1_referent",
        );
    ...
    fn anoncreds_works_for_credential_attr_tag_policy() {
        ...
        //1. Create Issuer wallet, gets wallet handle
        let (issuer_wallet_handle, issuer_wallet_config) = wallet::create_and_open_default_wallet(
            "anoncreds_works_for_credential_attr_tag_policy",
        )
        .unwrap();
        ...
        //3. Issuer creates Schema and Credential Definition
        let (_schema_id, _schema_json, cred_def_id, cred_def_json) =
            anoncreds::multi_steps_issuer_preparation(
                issuer_wallet_handle,
                ISSUER_DID,
                GVT_SCHEMA_NAME,
        ...
        let mut catpol_json =
            anoncreds::prover_get_credential_attr_tag_policy(prover_wallet_handle, &cred_def_id)
                .unwrap();
        ...
        anoncreds::prover_set_credential_attr_tag_policy(
            prover_wallet_handle,
            &cred_def_id,
            Some(taggable_attrs),
            false,
        ...
        let (search_handle, count) =
            anoncreds::prover_search_credentials(prover_wallet_handle, &filter_json).unwrap();
    ...
    fn anoncreds_works_for_credential_deletion() {
        ...
        let (issuer_wallet_handle, issuer_wallet_config) =
            wallet::create_and_open_default_wallet("anoncreds_works_for_credential_deletion")
                .unwrap();
    ...
    fn anoncreds_works_for_cred_def_rotation() {
        ...
        let cred_defs_json = json!({
            cred_def_id.as_str(): serde_json::from_str::<CredentialDefinition>(&cred_def_json).unwrap()
        }).to_string();
    ...
    fn anoncreds_fails_for_unmet_attr_value_restrictions() {
        ...
        //1. Create Issuer wallet, gets wallet handle
        let (issuer_wallet_handle, issuer_wallet_config) = wallet::create_and_open_default_wallet(
            "anoncreds_fails_for_unmet_attr_value_restrictions",
        )
        .unwrap();
    ...
    fn anoncreds_works_for_single_issuer_single_prover_fully_qualified_ids() {
        ...
        let credential_1 = anoncreds::get_credential_for_predicate_referent(
            &credentials_json,
            "predicate1_referent",
        );
        ...
        let cred_defs_json = json!({
            cred_def_id.clone(): serde_json::from_str::<CredentialDefinition>(&cred_def_json).unwrap()}).to_string();
        ...
        let cred_defs_json = json!({
            cred_def_id_1: serde_json::from_str::<CredentialDefinition>(&cred_def_json).unwrap()
        })
        .to_string();
    ...
    #[cfg(feature = "revocation_tests")]
    #[test]
    fn anoncreds_works_for_revocation_proof_using_two_credentials_from_same_revocation_registry() {
        // IS-1477
        Setup::empty();
        ...
        let rev_state_json_2 = anoncreds::create_revocation_state(
            blob_storage_reader_handle,
            &revoc_reg_def_json,
            &revoc_reg_entry_json,
            timestamp,
    ...
    fn anoncreds_proof_req_with_attr_value_restrict_by_attribute_value() {
        ...
        //1. Create Issuer wallet, gets wallet handle
        let (issuer_wallet_handle, issuer_wallet_config) = wallet::create_and_open_default_wallet(
            "anoncreds_proof_req_with_attr_value_restrict_by_attribute_value",
        )
        .unwrap();
        ...
        let credential_4 =
            anoncreds::get_credential_for_attr_referent(&credentials_json, "attr4_referent");
