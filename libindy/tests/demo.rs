...
use utils::{
    ...
    domain::anoncreds::{
        ...
        credential_for_proof_request::CredentialsForProofRequest, proof::Proof,
        revocation_registry::RevocationRegistry,
        revocation_registry_definition::RevocationRegistryDefinition,
        revocation_state::RevocationState, schema::Schema,
    },
...
fn anoncreds_demo_works() {
    ...
    let (
        issuer_create_wallet_receiver,
        issuer_create_wallet_command_handle,
        issuer_create_wallet_callback,
    ) = callback::_closure_to_cb_ec();

    let (
        prover_create_wallet_receiver,
        prover_create_wallet_command_handle,
        prover_create_wallet_callback,
    ) = callback::_closure_to_cb_ec();

    let (
        issuer_open_wallet_receiver,
        issuer_open_wallet_command_handle,
        issuer_open_wallet_callback,
    ) = callback::_closure_to_cb_ec_wallethandle();

    let (
        prover_open_wallet_receiver,
        prover_open_wallet_command_handle,
        prover_open_wallet_callback,
    ) = callback::_closure_to_cb_ec_wallethandle();

    let (
        issuer_create_schema_receiver,
        issuer_create_schema_command_handle,
        issuer_create_schema_callback,
    ) = callback::_closure_to_cb_ec_string_string();

    let (
        issuer_create_credential_definition_receiver,
        issuer_create_credential_definition_command_handle,
        issuer_create_credential_definition_callback,
    ) = callback::_closure_to_cb_ec_string_string();

    let (
        issuer_create_credential_offer_receiver,
        issuer_create_credential_offer_command_handle,
        issuer_create_credential_offer_callback,
    ) = callback::_closure_to_cb_ec_string();

    let (
        prover_create_master_secret_receiver,
        prover_create_master_secret_command_handle,
        prover_create_master_secret_callback,
    ) = callback::_closure_to_cb_ec_string();

    let (
        prover_create_credential_req_receiver,
        prover_create_credential_req_command_handle,
        prover_create_credential_req_callback,
    ) = callback::_closure_to_cb_ec_string_string();

    let (
        issuer_create_credential_receiver,
    ...
    let (
        prover_store_credential_receiver,
        prover_store_credential_command_handle,
    ...
    let (
        prover_create_proof_receiver,
        prover_create_proof_command_handle,
        prover_create_proof_callback,
    ) = callback::_closure_to_cb_ec_string();

    let (
        verifier_verify_proof_receiver,
        verifier_verify_proof_command_handle,
        verifier_verify_proof_callback,
    ) = callback::_closure_to_cb_ec_bool();

    let (
        issuer_close_wallet_receiver,
        issuer_close_wallet_command_handle,
        issuer_close_wallet_callback,
    ) = callback::_closure_to_cb_ec();

    let (
        prover_close_wallet_receiver,
        prover_close_wallet_command_handle,
        prover_close_wallet_callback,
    ) = callback::_closure_to_cb_ec();

    let (bs_writer_receiver, bs_writer_command_handle, bs_writer_cb) =
        callback::_closure_to_cb_ec_i32();

    let (bs_reader_receiver, bs_reader_command_handle, bs_reader_cb) =
        callback::_closure_to_cb_ec_i32();

    let (cs_rev_reg_receiver, cs_rev_reg_command_handle, cs_rev_reg_cb) =
        callback::_closure_to_cb_ec_string_string_string();

    let (create_rev_state_receiver, create_rev_state_command_handle, create_rev_state_cb) =
        callback::_closure_to_cb_ec_string();
    ...
    let err = unsafe {
        wallet::indy_create_wallet(
            issuer_create_wallet_command_handle,
            CString::new(issuer_wallet_config.as_str())
                .unwrap()
                .as_ptr(),
            CString::new(issuer_wallet_credentials.as_str())
                .unwrap()
                .as_ptr(),
            issuer_create_wallet_callback,
        )
    ...
    let err = issuer_create_wallet_receiver
        .recv_timeout(timeout::long_timeout())
        .unwrap();
    ...
    let (err, issuer_wallet_handle) = issuer_open_wallet_receiver
        .recv_timeout(timeout::long_timeout())
        .unwrap();
    ...
    let prover_wallet_credentials =
        json!({"key":"ProverKey1111111111111111111111111111111111", "key_derivation_method":"RAW"})
            .to_string();

    let err = unsafe {
        wallet::indy_create_wallet(
            prover_create_wallet_command_handle,
            CString::new(prover_wallet_config.as_str())
                .unwrap()
                .as_ptr(),
            CString::new(prover_wallet_credentials.as_str())
                .unwrap()
                .as_ptr(),
            prover_create_wallet_callback,
        )
    ...
    let err = prover_create_wallet_receiver
        .recv_timeout(timeout::long_timeout())
        .unwrap();
    ...
    let (err, prover_wallet_handle) = prover_open_wallet_receiver
        .recv_timeout(timeout::long_timeout())
        .unwrap();
    ...
    let err = unsafe {
        anoncreds::indy_issuer_create_schema(
            issuer_create_schema_command_handle,
    ...
    let (err, schema_id, schema_json) = issuer_create_schema_receiver
        .recv_timeout(timeout::long_timeout())
        .unwrap();
    ...
    let (err, credential_def_id, credential_def_json) =
        issuer_create_credential_definition_receiver
            .recv_timeout(timeout::long_timeout())
            .unwrap();
    ...
    let (err, tails_writer_handle) = bs_writer_receiver
        .recv_timeout(timeout::short_timeout())
        .unwrap();

    assert_eq!(ErrorCode::Success, ErrorCode::from(err));

    let err = unsafe {
        anoncreds::indy_issuer_create_and_store_revoc_reg(
            cs_rev_reg_command_handle,
            issuer_wallet_handle,
            CString::new(issuer_did).unwrap().as_ptr(),
            null(),
            CString::new("TAG1").unwrap().as_ptr(),
            CString::new(credential_def_id.as_str()).unwrap().as_ptr(),
            CString::new(r#"{"max_cred_num":5, "issuance_type":"ISSUANCE_ON_DEMAND"}"#)
                .unwrap()
                .as_ptr(),
            tails_writer_handle,
            cs_rev_reg_cb,
    ...
    let err = unsafe {
        anoncreds::indy_prover_create_master_secret(
            prover_create_master_secret_command_handle,
    ...
    let (err, _) = prover_create_master_secret_receiver
        .recv_timeout(timeout::long_timeout())
        .unwrap();
    ...
    let err = unsafe {
        anoncreds::indy_issuer_create_credential_offer(
            issuer_create_credential_offer_command_handle,
            issuer_wallet_handle,
            CString::new(credential_def_id.as_str()).unwrap().as_ptr(),
            issuer_create_credential_offer_callback,
    ...
    let (err, credential_offer_json) = issuer_create_credential_offer_receiver
        .recv_timeout(timeout::long_timeout())
        .unwrap();
    ...
    let err = unsafe {
        anoncreds::indy_prover_create_credential_req(
            prover_create_credential_req_command_handle,
            prover_wallet_handle,
            CString::new(prover_did).unwrap().as_ptr(),
            CString::new(credential_offer_json.as_str())
                .unwrap()
                .as_ptr(),
    ...
    let (err, credential_req_json, credential_req_metadata_json) =
        prover_create_credential_req_receiver
            .recv_timeout(timeout::long_timeout())
            .unwrap();
    ...
    let (err, blob_storage_reader_handle) = bs_reader_receiver
        .recv_timeout(timeout::short_timeout())
        .unwrap();
    ...
    let err = unsafe {
        anoncreds::indy_issuer_create_credential(
            issuer_create_credential_command_handle,
            issuer_wallet_handle,
    ...
    let err = unsafe {
        anoncreds::indy_prover_store_credential(
            prover_store_credential_command_handle,
            prover_wallet_handle,
    ...
    let (err, _) = prover_store_credential_receiver
        .recv_timeout(timeout::long_timeout())
        .unwrap();
    ...
    let err = unsafe {
        anoncreds::indy_prover_get_credentials_for_proof_req(
            prover_get_credentials_for_proof_req_command_handle,
            prover_wallet_handle,
    ...
    let (err, credentials_json) = prover_get_credentials_for_proof_req_receiver
        .recv_timeout(timeout::long_timeout())
        .unwrap();
    ...
    let err = unsafe {
        anoncreds::indy_create_revocation_state(
            create_rev_state_command_handle,
            blob_storage_reader_handle,
            CString::new(revoc_reg_def_json.as_str()).unwrap().as_ptr(),
            CString::new(rreg_issue_delta_json.as_str())
                .unwrap()
                .as_ptr(),
            issue_ts,
    ...
    let err = unsafe {
        anoncreds::indy_prover_create_proof(
            prover_create_proof_command_handle,
            prover_wallet_handle,
            CString::new(proof_req_json.as_str()).unwrap().as_ptr(),
            ...
            CString::new(credential_defs_json.as_str())
                .unwrap()
                .as_ptr(),
    ...
    let (err, proof_json) = prover_create_proof_receiver
        .recv_timeout(timeout::long_timeout())
        .unwrap();
    ...
    let err = unsafe {
        anoncreds::indy_verifier_verify_proof(
            verifier_verify_proof_command_handle,
    ...
    let (err, valid) = verifier_verify_proof_receiver
        .recv_timeout(timeout::long_timeout())
        .unwrap();
    ...
    let res = issuer_close_wallet_receiver
        .recv_timeout(timeout::medium_timeout())
        .unwrap();
    ...
    let res = prover_close_wallet_receiver
        .recv_timeout(timeout::medium_timeout())
        .unwrap();
...
fn ledger_demo_works() {
    ...
    let (
        set_protocol_version_receiver,
        set_protocol_version_command_handle,
    ...
    let (get_nym_receiver, get_nym_command_handle, get_nym_callback) =
        callback::_closure_to_cb_ec_string();

    let (create_my_wallet_receiver, create_my_wallet_command_handle, create_my_wallet_callback) =
        callback::_closure_to_cb_ec();

    let (
        create_their_wallet_receiver,
        create_their_wallet_command_handle,
        create_their_wallet_callback,
    ) = callback::_closure_to_cb_ec();

    let (open_my_wallet_receiver, open_my_wallet_command_handle, open_my_wallet_callback) =
        callback::_closure_to_cb_ec_wallethandle();

    let (open_their_wallet_receiver, open_their_wallet_command_handle, open_their_wallet_callback) =
        callback::_closure_to_cb_ec_wallethandle();

    let (
        create_and_store_my_did_receiver,
        create_and_store_my_did_command_handle,
        create_and_store_my_did_callback,
    ) = callback::_closure_to_cb_ec_string_string();

    let (
        create_and_store_their_did_receiver,
        create_and_store_their_did_command_handle,
        create_and_store_their_did_callback,
    ) = callback::_closure_to_cb_ec_string_string();

    let (store_their_did_receiver, store_their_did_command_handle, store_their_did_callback) =
        callback::_closure_to_cb_ec();

    let (close_pool_receiver, close_pool_command_handle, close_pool_callback) =
        callback::_closure_to_cb_ec();
    ...
    let (
        close_their_wallet_receiver,
        close_their_wallet_command_handle,
        close_their_wallet_callback,
    ) = callback::_closure_to_cb_ec();

    let (build_nym_request_receiver, build_nym_request_command_handle, build_nym_request_callback) =
        callback::_closure_to_cb_ec_string();

    let (
        build_get_nym_request_receiver,
        build_get_nym_request_command_handle,
        build_get_nym_request_callback,
    ) = callback::_closure_to_cb_ec_string();

    // Set protocol version
    let err = unsafe {
        pool::indy_set_protocol_version(
            set_protocol_version_command_handle,
            PROTOCOL_VERSION,
            set_protocol_version_callback,
        )
    ...
    let err = set_protocol_version_receiver
        .recv_timeout(timeout::short_timeout())
        .unwrap();
    ...
    let err = unsafe {
        pool::indy_create_pool_ledger_config(
    ...
    let (err, pool_handle) = open_receiver
        .recv_timeout(timeout::short_timeout())
        .unwrap();
    ...
    let err = unsafe {
        wallet::indy_create_wallet(
            create_my_wallet_command_handle,
    ...
    let err = create_my_wallet_receiver
        .recv_timeout(timeout::long_timeout())
        .unwrap();
    ...
    let (err, my_wallet_handle) = open_my_wallet_receiver
        .recv_timeout(timeout::long_timeout())
        .unwrap();
    ...
    let err = create_their_wallet_receiver
        .recv_timeout(timeout::long_timeout())
        .unwrap();
    ...
    let err = unsafe {
        wallet::indy_open_wallet(
            open_their_wallet_command_handle,
            CString::new(their_wallet_config.as_str()).unwrap().as_ptr(),
            CString::new(WALLET_CREDENTIALS).unwrap().as_ptr(),
    ...
    let (err, their_wallet_handle) = open_their_wallet_receiver
        .recv_timeout(timeout::long_timeout())
        .unwrap();
    ...
    let err = unsafe {
        did::indy_create_and_store_my_did(
            create_and_store_my_did_command_handle,
            my_wallet_handle,
    ...
    let (err, my_did, my_verkey) = create_and_store_my_did_receiver
        .recv_timeout(timeout::long_timeout())
        .unwrap();
    ...
    let (err, their_did, their_verkey) = create_and_store_their_did_receiver
        .recv_timeout(timeout::long_timeout())
        .unwrap();
    ...
    let err = unsafe {
        did::indy_store_their_did(
            store_their_did_command_handle,
            my_wallet_handle,
    ...
    let err = store_their_did_receiver
        .recv_timeout(timeout::long_timeout())
        .unwrap();
    ...
    let err = unsafe {
        ledger::indy_build_nym_request(
            build_nym_request_command_handle,
    ...
    let (err, request) = build_nym_request_receiver
        .recv_timeout(timeout::long_timeout())
        .unwrap();
    ...
    let err = unsafe {
        ledger::indy_sign_and_submit_request(
            send_command_handle,
            pool_handle,
            their_wallet_handle,
            CString::new(their_did.as_str()).unwrap().as_ptr(),
    ...
    let err = unsafe {
        ledger::indy_build_get_nym_request(
            build_get_nym_request_command_handle,
            CString::new(my_did.as_str()).unwrap().as_ptr(),
            CString::new(my_did.as_str()).unwrap().as_ptr(),
            build_get_nym_request_callback,
    ...
    let (err, request) = build_get_nym_request_receiver
        .recv_timeout(timeout::long_timeout())
        .unwrap();
    ...
    let err = unsafe {
        ledger::indy_submit_request(
            get_nym_command_handle,
            pool_handle,
            CString::new(request).unwrap().as_ptr(),
            get_nym_callback,
        )
    ...
    let get_nym_resp_data: ReplyResultData =
        serde_json::from_str(&get_nym_resp.result.data.as_ref().unwrap()).unwrap();
    ...
    let res = unsafe {
        wallet::indy_close_wallet(
            close_my_wallet_command_handle,
            my_wallet_handle,
            close_my_wallet_callback,
        )
    };

    assert_eq!(ErrorCode::from(res), ErrorCode::Success);

    let res = close_my_wallet_receiver
        .recv_timeout(timeout::medium_timeout())
        .unwrap();
    ...
    let res = close_their_wallet_receiver
        .recv_timeout(timeout::medium_timeout())
        .unwrap();
...
fn crypto_demo_works() {
    ...
    let (create_wallet_receiver, create_wallet_command_handle, create_wallet_callback) =
        callback::_closure_to_cb_ec();

    let (open_wallet_receiver, open_wallet_command_handle, open_wallet_callback) =
        callback::_closure_to_cb_ec_wallethandle();

    let (
        create_and_store_did_receiver,
        create_and_store_did_command_handle,
        create_and_store_did_callback,
    ) = callback::_closure_to_cb_ec_string_string();

    let (sign_receiver, sign_command_handle, sign_callback) = callback::_closure_to_cb_ec_vec_u8();

    let (verify_receiver, verify_command_handle, verify_callback) =
        callback::_closure_to_cb_ec_bool();
    ...
    let err = create_wallet_receiver
        .recv_timeout(timeout::long_timeout())
        .unwrap();
    ...
    let (err, wallet_handle) = open_wallet_receiver
        .recv_timeout(timeout::long_timeout())
        .unwrap();
    ...
    let (err, _, verkey) = create_and_store_did_receiver
        .recv_timeout(timeout::long_timeout())
        .unwrap();
    ...
    // 5. Verify message
    let err = unsafe {
        crypto::indy_crypto_verify(
            verify_command_handle,
    ...
    let res = unsafe {
        wallet::indy_close_wallet(
            close_wallet_command_handle,
            wallet_handle,
            close_wallet_callback,
        )
    };

    assert_eq!(ErrorCode::from(res), ErrorCode::Success);

    let res = close_wallet_receiver
        .recv_timeout(timeout::medium_timeout())
        .unwrap();
