...
# libindy 1.11.1 stable
# libnullpay 1.11.1 stable
# libsovtoken 1.0.2-201909020930-18989f4 stable
# libvcx 0.4.53976923-bd81815fc
...
through to the libvcx shared library.
  ...
  s.source           = { :http => 'https://repo.corp.evernym.com/filely/ios/vcx.libvcxpartial_0.4.53976923-bd81815fc_universal.zip' }
